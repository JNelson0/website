							...
							<Col sm={9}>
								<Tab.Content>
									<Tab.Pane eventKey="first">
										<h2>Summary</h2>
										<p>
											The Movie Finder web application
											creates a portal for users to view
											all available movies with streaming
											capability hosted on top media
											streaming services (Netflix, HBO,
											Hulu, etc.) If users don't know what
											a streaming platform offers before
											signing up for pricy subscriptions
											they can use Movie Finder to look at
											available streaming capabilities
											from each platform before making a
											decision.
										</p>
										<h2>How does it work?</h2>
										<p>
											Movie Finder pulls current movie and
											tv-show data using Selenium web
											driver and Python webscraping,
											compiling the data into a PostgreSQL
											databse which is then converted by
											React, HTML, and CSS into a website
											suitable for users. Selecting a
											movie or tv-show will connect the
											user directly to the associated host
											streaming platform.
										</p>
									</Tab.Pane>
